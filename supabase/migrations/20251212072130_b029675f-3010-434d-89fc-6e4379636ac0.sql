-- Drop all existing versions of get_trip_aggregation to resolve function overloading
DROP FUNCTION IF EXISTS public.get_trip_aggregation(text, text, text[], text[], text[], integer[], text[], text[], text[]);
DROP FUNCTION IF EXISTS public.get_trip_aggregation(text, text, text[], text[], text[], integer[], text[], text[], text[], double precision, double precision, double precision, double precision, double precision, double precision);
DROP FUNCTION IF EXISTS public.get_trip_aggregation(text, text, text[], text[], text[], integer[], text[], text[], text[], double precision, double precision, double precision, double precision, double precision, double precision, integer);
...
BEGIN
  ...
  -- Return aggregated data with k-anonymity threshold
